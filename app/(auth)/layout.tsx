...
const Layout = ({children}: { children: React.ReactNode }) => {
    return (
        <div className="flex min-h-screen">
            <section className={"bg-primary px-10 hidden h-screen md:block md:w-1/2 lg:w-2/5"}>
                <div className="flex flex-col justify-around h-screen max-w-[480] mx-auto">
                    <Image
            ...
            <section className="bg-secondary text-secondary-foreground flex flex-col items-center h-screen w-full md:w-1/2 lg:w-3/5 px-5 py-10 md:justify-around">
